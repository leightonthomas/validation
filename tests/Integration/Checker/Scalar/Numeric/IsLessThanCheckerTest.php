...
class IsLessThanCheckerTest extends CheckerTest
{
     ...
     * @throws NoCheckersRegistered
     */
    public function itWillAddCustomerErrorIfConfiguredAndTooShort($value, $comparisonValue): void
    {
        $rule = new IsLessThan($comparisonValue);
     ...
     * @throws NoCheckersRegistered
     */
    public function itWillAddCustomerErrorIfConfiguredAndTooShortAndEqualIsAllowed($value, $comparisonValue): void
    {
        $rule = new IsLessThan($comparisonValue);
        $rule->allowEqual();
